...
function About() {
  return (
    <div className="about-container">
      <h1 className="animated-heading">Pricing</h1>
      ...
      <div className="about-cards">
        <div className="about-card">
          <h2>PT Plan</h2>
          <p>I will provide nutrition advice, customised fitness plan to suit your goals, and weekly check-in calls</p>
        ...
        <div className="about-card">
          ...
          <p>I will provide a nutrition plan based on dietary requirements, and fitness goals.</p>
          <h3>What's Included:</h3>
          <ul className="included-list">
        ...
        <div className="about-card">
          ...
          <p>I will provide a customised fitness plan to suit your training goals.</p>
          <h3>What's Included:</h3>
          <ul className="included-list">
